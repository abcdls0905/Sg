...
namespace Entitas {
    ...
    public class Context<TEntity> : IContext<TEntity> where TEntity : class, IEntity {
        ...
        public event ContextChanged OnContextReset;
        ...
        private void DestroyEntity(TEntity entity) {
        ...
        public void DestroyAllEntities() {
            ...
            for (int i = entities.Length - 1; i >=0 ; i--) {
                if (_singleEntityCache != entities[i])
                    entities[i].Destroy();
            }
        }

        public void DestroySingleEntity()
        {
            if (_singleEntityCache != null)
                _singleEntityCache.Destroy();
        ...
        public TEntity SingleEntity
        {
            ...
            {
                if (_singleEntityCache == null)
                    _singleEntityCache = CreateEntity();
        ...
        public void Reset() {
            ...
            while (iter.MoveNext())
                iter.Current.RemoveAllEventHandlers();
