...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 34, 13, 13);
        ...
        static int _m_Simulate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    float step = (float)LuaAPI.lua_tonumber(L, 1);
        ...
        static int _m_RebuildBroadphaseRegions_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Bounds worldBounds;translator.Get(L, 1, out worldBounds);
                    int subdivisions = LuaAPI.xlua_tointeger(L, 2);
