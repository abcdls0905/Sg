...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGTextFieldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "rtl", _g_get_rtl);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "rtl", _s_set_rtl);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.GTextField __cl_gen_ret = new FairyGUI.GTextField();
        ...
        static int _m_Setup_BeforeAdd(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_singleLine(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.singleLine);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_stroke(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.stroke);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_strokeColor(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineColor(L, __cl_gen_to_be_invoked.strokeColor);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_shadowOffset(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.shadowOffset);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_UBBEnabled(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.UBBEnabled);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_autoSize(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.autoSize);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_rtl(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.rtl);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_textWidth(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.textWidth);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_textHeight(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.textHeight);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_singleLine(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.singleLine = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_stroke(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.stroke = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _s_set_strokeColor(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                UnityEngine.Color __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.strokeColor = __cl_gen_value;
        ...
        static int _s_set_shadowOffset(RealStatePtr L)
        {
		    try {
				...
				__cl_gen_to_be_invoked.shadowOffset = __cl_gen_value;
        ...
        static int _s_set_UBBEnabled(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.UBBEnabled = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_autoSize(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                FairyGUI.AutoSizeType __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.autoSize = __cl_gen_value;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_rtl(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GTextField __cl_gen_to_be_invoked = (FairyGUI.GTextField)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.rtl = LuaAPI.lua_toboolean(L, 2);
