...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGComboBoxWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 5, 14, 13);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.GComboBox __cl_gen_ret = new FairyGUI.GComboBox();
        ...
        static int _m_HandleControllerChanged(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
        ...
        static int _m_UpdateDropdownList(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.UpdateDropdownList(  );
        ...
        static int _g_get_icons(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.icons);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_popupDirection(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, __cl_gen_to_be_invoked.popupDirection);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_visibleItemCount(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.visibleItemCount);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_items(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.items = (string[])translator.GetObject(L, 2, typeof(string[]));
        ...
        static int _s_set_icons(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.icons = (string[])translator.GetObject(L, 2, typeof(string[]));
        ...
        static int _s_set_values(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.values = (string[])translator.GetObject(L, 2, typeof(string[]));
        ...
        static int _s_set_popupDirection(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.popupDirection = LuaAPI.lua_tostring(L, 2);
        ...
        static int _s_set_visibleItemCount(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.visibleItemCount = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _s_set_dropdown(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComboBox __cl_gen_to_be_invoked = (FairyGUI.GComboBox)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.dropdown = (FairyGUI.GComponent)translator.GetObject(L, 2, typeof(FairyGUI.GComponent));
