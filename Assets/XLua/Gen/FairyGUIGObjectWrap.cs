...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 37, 92, 45);
        ...
        static int _g_get_onTouchMove(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.onTouchMove);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_sourceWidth(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.sourceWidth = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _s_set_sourceHeight(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.sourceHeight = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _s_set_initWidth(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.initWidth = LuaAPI.xlua_tointeger(L, 2);
        ...
        static int _s_set_initHeight(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GObject __cl_gen_to_be_invoked = (FairyGUI.GObject)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.initHeight = LuaAPI.xlua_tointeger(L, 2);
