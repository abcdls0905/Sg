...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 3, 28, 28);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "ClearResourceRefs", _m_ClearResourceRefs_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetSoundLoader", _m_SetSoundLoader_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "rightToLeftText", _g_get_rightToLeftText);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "rightToLeftText", _s_set_rightToLeftText);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetSoundLoader_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    FairyGUI.UIConfig.SoundLoader loader = translator.GetDelegate<FairyGUI.UIConfig.SoundLoader>(L, 1);
                    
                    FairyGUI.UIConfig.SetSoundLoader( loader );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_rightToLeftText(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushboolean(L, FairyGUI.UIConfig.rightToLeftText);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_rightToLeftText(RealStatePtr L)
        {
		    try {
                
			    FairyGUI.UIConfig.rightToLeftText = LuaAPI.lua_toboolean(L, 1);
