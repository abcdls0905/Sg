...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITransitionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 12, 7, 5);
        ...
        static int _m_Copy(RealStatePtr L)
        {
		    try {
                ...
                {
                    FairyGUI.Transition source = (FairyGUI.Transition)translator.GetObject(L, 2, typeof(FairyGUI.Transition));
                    
                    __cl_gen_to_be_invoked.Copy( source );
