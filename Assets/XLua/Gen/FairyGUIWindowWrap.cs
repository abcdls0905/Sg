    ...
    public class FairyGUIWindowWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.Window __cl_gen_ret = new FairyGUI.Window();
        ...
        static int _m_AddUISource(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    FairyGUI.IUISource source = (FairyGUI.IUISource)translator.GetObject(L, 2, typeof(FairyGUI.IUISource));
                    
                    __cl_gen_to_be_invoked.AddUISource( source );
        ...
        static int _m_ShowOn(RealStatePtr L)
        {
		    try {
                ...
                {
                    FairyGUI.GRoot r = (FairyGUI.GRoot)translator.GetObject(L, 2, typeof(FairyGUI.GRoot));
                    
                    __cl_gen_to_be_invoked.ShowOn( r );
        ...
        static int _m_HideImmediately(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.HideImmediately(  );
        ...
        static int _m_CenterOn(RealStatePtr L)
        {
		    try {
                ...
                {
                    FairyGUI.GRoot r = (FairyGUI.GRoot)translator.GetObject(L, 2, typeof(FairyGUI.GRoot));
                    bool restraint = LuaAPI.lua_toboolean(L, 3);
                    
                    __cl_gen_to_be_invoked.CenterOn( r, restraint );
        ...
        static int _m_ToggleStatus(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.ToggleStatus(  );
        ...
        static int _m_BringToFront(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.BringToFront(  );
        ...
        static int _m_ShowModalWait(RealStatePtr L)
        {
		    try {
                ...
                {
                    int requestingCmd = LuaAPI.xlua_tointeger(L, 2);
                    
                    __cl_gen_to_be_invoked.ShowModalWait( requestingCmd );
        ...
        static int _m_CloseModalWait(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 1) 
                {
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.CloseModalWait(  );
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    int requestingCmd = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.CloseModalWait( requestingCmd );
                        LuaAPI.lua_pushboolean(L, __cl_gen_ret);
        ...
        static int _g_get_bringToFontOnClick(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.bringToFontOnClick);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_frame(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.frame);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_closeButton(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.closeButton);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_dragArea(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.dragArea);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_contentArea(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.contentArea);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_modalWaitingPane(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.modalWaitingPane);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_isTop(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.isTop);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_modal(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.modal);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_bringToFontOnClick(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.bringToFontOnClick = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_contentPane(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.contentPane = (FairyGUI.GComponent)translator.GetObject(L, 2, typeof(FairyGUI.GComponent));
        ...
        static int _s_set_closeButton(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.closeButton = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
        ...
        static int _s_set_dragArea(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.dragArea = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
        ...
        static int _s_set_contentArea(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.contentArea = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
        ...
        static int _s_set_modal(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Window __cl_gen_to_be_invoked = (FairyGUI.Window)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.modal = LuaAPI.lua_toboolean(L, 2);
