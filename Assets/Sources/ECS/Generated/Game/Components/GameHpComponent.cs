...
public partial class GameEntity {
    ...
    public Game.HpComponent hp { get { return (Game.HpComponent)GetComponent(GameComponentsLookup.Hp); } }
    public bool hasHp { get { return HasComponent(GameComponentsLookup.Hp); } }

    public Game.HpComponent AddHp() {
        var index = GameComponentsLookup.Hp;
        var component = CreateComponent<Game.HpComponent>(index);
