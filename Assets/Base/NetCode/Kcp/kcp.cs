...
/*
 * v1.0 From github.com/limpo1989/kcp-csharp
 * v1.1 by ZZH 调整 Input Send Recv 参数格式，方便上层复用数组
 */
    ...
    public class KCP
    {
        ...
        public int Input(byte[] data, int len)
        {
            ...
            while (true)
            {
                ...
                if (len - offset < IKCP_OVERHEAD) break;
