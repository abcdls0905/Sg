    ...
    public partial class XCProject : System.IDisposable
    {
        ...
        {    
            ...
            foreach( string filePath in mod.files ) {
                ...
                //                 if (filePath == "Entitlements.plist") {
                //                     absoluteFilePath = System.IO.Path.Combine( projectRootPath, "Entitlements.plist" );
                //                 }
                string destPath = System.IO.Path.Combine(projectRootPath, filePath);
                System.IO.File.Copy(absoluteFilePath, destPath, true);
                this.AddFile(destPath, modGroup );
            }
